  ...
  render() {
    ...
    return (
      <FormStruct
        ...
        subtitle={
          <div>
            <strong>Please confirm your donation.</strong> Once you confirm, funds will be sent from your intermediate Bitcoin wallet to the Musereum Fundraiser exodus address.
          </div>
        }
        submit={
          <Btn
