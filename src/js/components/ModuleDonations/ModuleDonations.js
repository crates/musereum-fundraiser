...
export default class ModuleDonations extends Component { // eslint-disable-line
  ...
  state = {
    ...
    etcLink: `https://gastracker.io/addr/${cfr.ethereumclassic.FUNDRAISER_CONTRACT}`
  }
    ...
    return (
      ...
      >
        <div className="md-sections">
          ...
          <section>
            <h3>ETC</h3>
            <p>View the history of Ether Classic contributions on Gastracker (gastracker.io)</p>
